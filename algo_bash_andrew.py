...
from model import CustomGraphLinearModel2, CustomGraphSAGEModel
...
if __name__ == "__main__":
    ...
    model = CustomGraphSAGEModel(dataset.num_features, 4096, dataset.num_classes)
    # Computation graph
    graph = create_graph(model, True)
    print_graph(graph)
